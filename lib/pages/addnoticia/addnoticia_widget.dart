...
import 'addnoticia_model.dart';
export 'addnoticia_model.dart';

class AddnoticiaWidget extends StatefulWidget {
  const AddnoticiaWidget({super.key});

  @override
  _AddnoticiaWidgetState createState() => _AddnoticiaWidgetState();
}

class _AddnoticiaWidgetState extends State<AddnoticiaWidget> {
  late AddnoticiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddnoticiaModel());
    ...
    _model.contenidoFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator:
                        _model.tituloControllerValidator.asValidator(context),
                  ),
                ),
                Padding(
                  padding:
                  ...
                  child: TextFormField(
                    ...
                    focusNode: _model.contenidoFocusNode,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await NoticiasRecord.collection.doc().set({
                          ...createNoticiasRecordData(
                            autor: currentUserDisplayName,
                            contenido: _model.contenidoController.text,
